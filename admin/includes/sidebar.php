		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					<ul>
						<li> <a href="./add_tags.php"><i class='bx bx-radio-circle'></i>Add Tags </a>
						</li>
						<li> <a href="./manage_tags.php"><i class='bx bx-radio-circle'></i>manage tags</a>
						</li>
						<li> <a href="./add_question.php"><i class='bx bx-radio-circle'></i>Add Questions</a>
						</li>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li> <a href="./register_admin.html"><i class='bx bx-radio-circle'></i>Register</a>
						</li>
						<li> <a href="./login_admin.html"><i class='bx bx-radio-circle'></i>Login</a>
						</li>
						<li> <a href="./success_ratio_predictor"><i class='bx bx-radio-circle'></i>Logout</a>
						</li>
				...
				<li>
					<a class="has-arrow" href="javascript:;">
						...
						<div class="menu-title">Topical Subscription</div>
					</a>
					<ul>
						<li> <a href="./topicalcalculator.php"><i class='bx bx-radio-circle'></i>Attempt Test</a>
						</li>
						<li> <a href="#"><i class='bx bx-radio-circle'></i>Design Your Own Test</a>
						</li>
				...
				<!-- <li>
					...
					<ul>
						<li> <a href="./testresult/preresult.php"><i class='bx bx-radio-circle'></i>Pre Results</a>
						</li>
						<li> <a href="./testresult/mainsresult.php"><i class='bx bx-radio-circle'></i>Mains Result</a>
						</li>
