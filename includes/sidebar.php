		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					<ul>
						<li> <a href="./dashboard.php"><i class='bx bx-radio-circle'></i>Dashboard</a>
						</li>
						<li> <a href="./trackyourprocess.php"><i class='bx bx-radio-circle'></i>Track Your Progress</a>
						</li>
						</li>
					</ul>
				</li>
				...
				<li class="menu-label">BETA Products</li>
				<!-- <li>
					<a href="widgets.html">
				...
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">Calculators</div>
					</a>
					<ul>
						<li> <a href="./pre_result_calculator"><i class='bx bx-radio-circle'></i>Pre Result Calculator</a>
						</li>
						<li> <a href="./success_ratio_predictor"><i class='bx bx-radio-circle'></i>Success Ratio Calculator</a>
						</li>
