		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					<ul>
						<li> <a href="./student_dashboard.php"><i class='bx bx-radio-circle'></i>Dashboard</a>
						</li>
				...
				<li>
					...
					<ul>
						<li> <a href="./preresult.php"><i class='bx bx-radio-circle'></i>Pre Results</a>
						</li>
						<li> <a href="./mainsresult.php"><i class='bx bx-radio-circle'></i>Mains Result</a>
						</li>
