...
<body>
    ...
    <!-- <h5>Welcome, <?php echo htmlspecialchars($_SESSION['email']); ?></h5> -->
        <div class="container">
            <div class="row">
                <div class="col-md-7 animated-element slide-in-left">
                    <h2><?php echo $heading; ?></h2>
                    <p><?php echo $paragraph; ?></p>
                    <h2 class="mt-5 animated-element fade-in">Key areas where you can improve</h2>
                    <p class="animated-element fade-in">Sorry, we cannot show this result currently because your subject-wise rating is not being monitored.</p>
                </div>
                <div class="col-md-5 animated-element slide-in-right">
